...
# 11 Official WOPC Sheet URLs and their EXACT card counts
# Major: 8 + 8 + 6 = 22
# Wands: 8 + 6 = 14
# Cups: 8 + 6 = 14
# Swords: 8 + 6 = 14
# Coins: 8 + 6 = 14
SHEET_SPECS = [
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-major-arcana-01.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-major-arcana-02.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-major-arcana-03.jpg", 6),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-wands-01.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-wands-02.jpg", 6),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-cups-01.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-cups-02.jpg", 6),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-swords-01.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-swords-02.jpg", 6),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-coins-01.jpg", 8),
    ("https://www.wopc.co.uk/images/contributors/adamwintle/12417-pixel-tarot/pixel-tarot-minor-arcana-coins-02.jpg", 6),
]

# EXACT 78 RIDER-WAITE TAROT CARD NAMES
CARD_NAMES_STRICT = [
    # Major Arcana (00-21) - 22 cards
    ...
    # Pentacles / Coins (64-77) - 14 cards
...
def process_perfect_78():
    print("Starting 100% exact slicing of 78 Rider-Waite pixel tarot cards...")
    all_cards = []
    
    for sheet_idx, (url, valid_count) in enumerate(SHEET_SPECS):
        ...
        for r in range(rows):
            for c in range(cols):
                if extracted_count < valid_count:
                    box = (c * card_w, r * card_h, (c + 1) * card_w, (r + 1) * card_h)
                    card_crop = sheet_img.crop(box)
                    all_cards.append(card_crop)
                    extracted_count += 1
        print(f"Sheet {sheet_idx+1}: Extracted {extracted_count} valid cards.")
    ...
    for idx in range(78):
        ...
        card_img = all_cards[idx].resize((140, 210), Image.Resampling.LANCZOS)
    ...
    print("SUCCESS: 78 Rider-Waite tarot cards generated with 100% exact mapping!")
